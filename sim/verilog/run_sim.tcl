# ==============================================================
# File generated on Sat May 03 15:56:58 +0700 2025
# Vivado(TM) HLS - High-Level Synthesis from C, C++ and SystemC v2018.3 (64-bit)
# SW Build 2405991 on Thu Dec  6 23:38:27 MST 2018
# IP Build 2404404 on Fri Dec  7 01:43:56 MST 2018
# Copyright 1986-2018 Xilinx, Inc. All Rights Reserved.
# ==============================================================
set ::env(PATH) "$::env(PATH);D:/Vitis_2018/Vivado/2018.3/win64/tools/fpo_v7_0"

set ::env(PATH) "$::env(PATH);D:/Vitis_2018/Vivado/2018.3/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);D:/Vitis_2018/Vivado/2018.3/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);D:/Vitis_2018/Vivado/2018.3/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);D:/Vitis_2018/Vivado/2018.3/win64/tools/dds_v6_0"
...
if {[file isfile Convolution2D.autotvin.dat]} {
	file delete -force Convolution2D.autotvin.dat
}

if {[file isfile Convolution2D.autotvout.dat]} {
	file delete -force Convolution2D.autotvout.dat
}
