// ==============================================================
// File generated on Sat May 03 15:56:06 +0700 2025
...
`define AUTOTB_DUT      Convolution2D
`define AUTOTB_DUT_INST AESL_inst_Convolution2D
`define AUTOTB_TOP      apatb_Convolution2D_top
`define AUTOTB_LAT_RESULT_FILE "Convolution2D.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "Convolution2D.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_Convolution2D_top
...
`define AUTOTB_TVIN_input_r_out_wrapc  "../tv/rtldatafile/rtl.Convolution2D.autotvin_input_r.dat"
`define AUTOTB_TVIN_kernel_out_wrapc  "../tv/rtldatafile/rtl.Convolution2D.autotvin_kernel.dat"
...
parameter LATENCY_ESTIMATION = 1132;
